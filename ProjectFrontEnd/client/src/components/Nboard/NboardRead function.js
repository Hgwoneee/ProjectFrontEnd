...
const NboardRead = (props) => {
    ...
    const deleteComment = (index) => {
        sweetalertDelete2('삭제하시겠습니까?', () => {
            axios.delete(`/api/nreplys/${responseReplyList.data[index].rno}/${bno}`, {
                        ...
                        <article class="res_w">
                            <div class="tb_outline">
                                ...
                                <div id="modifyButton" class="btn_confirm mt20" style={{ "margin-bottom": "44px", textAlign: "center" }}>
                                    <Link to={`/NboardModify/${bno}`} className="bt_ty bt_ty2 submit_ty1 saveclass">수정</Link>
                                    <a href='javascript:' className="bt_ty bt_ty2 submit_ty1 saveclass"
                                        onClick={(e) => deleteArticle(e)}>삭제</a>
                                </div>
                            </div>
                        </article>
                    </form>
